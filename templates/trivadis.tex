...
$else$
\usepackage{lastpage}
\newcommand*{\TVDLogo}{$if(logo)$\includegraphics[width=0.2\textwidth]{$logo$}$endif$}
\usepackage[headsepline,footsepline]{scrlayer-scrpage}

\newpairofpagestyles{eisvogel-header-footer}{
  \clearpairofpagestyles
  \ihead[$if(header-right)$$header-right$$else$ \TVDLogo $endif$]{$if(header-left)$$header-left$$else$$endif$}
  \chead[$if(header-center)$$header-center$$else$$endif$]{$if(header-center)$$header-center$$else$$endif$}
  \ohead[$if(header-left)$$header-left$$else$$endif$]{$if(header-right)$$header-right$$else$ \TVDLogo $endif$}
  \ifoot[$if(footer-right)$$footer-right$$else$\thepage\ / \pageref*{LastPage}$endif$]{$if(footer-left)$$footer-left$$else$$title$$endif$}
  \cfoot[$if(footer-center)$$footer-center$$else$$endif$]{$if(footer-center)$$footer-center$$else$$endif$}
  \ofoot[$if(footer-left)$$footer-left$$else$$title$$endif$]{$if(footer-right)$$footer-right$$else$\thepage\ / \pageref*{LastPage}$endif$}
