...
$else$
\usepackage{lastpage}
\newcommand*{\TVDLogo}{$if(footer-logo)$\includegraphics[width=\textwidth,valign=c]{$footer-logo$}$endif$}
...
\newpairofpagestyles{eisvogel-header-footer}{
  ...
  \ifoot[$if(footer-right)$$footer-right$$else$\thepage\ / \pageref*{LastPage}$endif$]{$if(footer-left)$$footer-left$$else$\TVDLogo\ $title$$endif$}
  \cfoot[$if(footer-center)$$footer-center$$else$$endif$]{$if(footer-center)$$footer-center$$else$$endif$}
  \ofoot[$if(footer-left)$$footer-left$$else$\TVDLogo\ $title$$endif$]{$if(footer-right)$$footer-right$$else$\thepage\ / \pageref*{LastPage}$endif$}
