...
\definecolor{default-bulletcolor}{HTML}{9600FF}
...
\newpairofpagestyles{eisvogel-header-footer}{
  ...
  \ifoot[$if(footer-right)$$footer-right$$else$\thepage\ / \pageref*{LastPage}$endif$]{$if(footer-left)$$footer-left$$else$\TVDLogo$endif$}
  \cfoot[$if(footer-center)$$footer-center$$else$$title$$endif$]{$if(footer-center)$$footer-center$$else$$title$$endif$}
  \ofoot[$if(footer-left)$$footer-left$$else$\TVDLogo$endif$]{$if(footer-right)$$footer-right$$else$\thepage\ / \pageref*{LastPage}$endif$}
