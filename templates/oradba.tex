...
$if(strikeout)$
% Robust underline/strikeout:
% 1) Try ulem (no \underline/\underbar warnings).
% 2) Else try soul.
% 3) Else define tiny shims so documents still compile.
\makeatletter
\@ifpackageloaded{ulem}{}{%
  \IfFileExists{ulem.sty}{%
    \usepackage[normalem]{ulem}% provides \uline, \uuline, \sout, \xout, \uwave
  }{%
    \IfFileExists{soul.sty}{%
      \usepackage{soul}% provides \ul, \st (may warn about changed \underline/\underbar)
    }{%
      % --- Minimal shims (no package available) ---
      \providecommand{\uline}[1]{\underline{##1}}
      \providecommand{\uuline}[1]{\underline{##1}}% simple stand-in
      \providecommand{\sout}[1]{##1}% no strikeout available
      \providecommand{\xout}[1]{##1}
      \providecommand{\uwave}[1]{\underline{##1}}
      % Optional compat for documents using soul's \ul / \st:
