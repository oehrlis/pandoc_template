...
$if(beamer)$
  ...
  $else$
    \logo{\includegraphics{images/TVDLogo2019.eps}}
  $endif$
$endif$
...
% tables
$if(tables)$
  \definecolor{table-row-color}{HTML}{FFFFFF}
  \definecolor{table-rule-color}{HTML}{AAAAAA}
  \definecolor{tvdgray2}{gray}{0.8} 
...
$else$
  ...
  \newcommand*{\TVDLogo}{$if(logo)$\includegraphics[width=0.2\textwidth]{$logo$}$else$\includegraphics[width=0.2\textwidth]{images/TVDLogo2019.eps}$endif$}
